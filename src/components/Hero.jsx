        ...
        <div className='my-7 sm:my-0 max-w-[1200px] h-auto mx-auto flex flex-col-reverse sm:flex-row justify-center align-center'>
            <div className='flex-col my-auto mx-auto'>
                ...
                <h1 className='md:text-7xl sm:text-6xl text-4xl font-bold md:py-6 text-[#FF44EC]'>
                    <TypeAnimation sequence={["Frontend Dev",1000,"Backend Dev",1000]} wrapper='span' speed={50} repeat={Infinity}/>
                </h1>
                <div className='flex justify-start items-center'>
                    <p className='md:text5xl sm:text-4xl text-xl font-bold text-gray-500'>with a 7+ years experience</p>
                </div>
                ...
                <div className='relative inline-flex group my-3'>
                    ...
                    <a href='/' title='Download Resume' role='button' className='w-[225px] h-[60px] relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white transition-all duration-200 bg-primary-color font-pj rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900'>Download Resume</a>
                </div>
            </div>
